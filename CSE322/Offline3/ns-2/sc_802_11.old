...
endToEndDelay_file="multi_radio_802_11_random_endToEndDelay.dps"
throughput_file="multi_radio_802_11_random_throughput.dps"
packet_delivery_ratio_file="multi_radio_802_11_random_packetDeliveryRatio.dps"
packet_drop_ratio_file="multi_radio_802_11_random_packetDropRatio.dps"
energy_consumption_file="multi_radio_802_11_random_energyConsumption.dps"
iteration_float=5.0;
...
do
	...
	ns 802_11_udp.tcl $r ${num_node[$k]} $num_flow $num_packet_per_sec $node_speed # $dist_11 $pckt_size $pckt_per_sec $routing $time_sim
